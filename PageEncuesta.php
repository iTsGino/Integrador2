...
$sql = $Con->prepare("SELECT * FROM usuario u, alumno a WHERE u.USUARIO = a.USUARIO AND a.USUARIO = '$Usuario'");
$sql->execute();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Encuesta al Docente</h1>
                    </div>
                    <div class="container">
                        <div class="row">
                            <?php
                                //include 'GestionPerfil/AluGestion.php';
                                $sql3 = $Con->prepare("SELECT * FROM encuesta where DniAlu = '$DniAlu';");
                                $sql3->execute();
                                ...
                                if(isset($Veces)){
                                    if($Veces<=2){
                                        echo '<script>alert("Success: Ya realizaste la Encuesta, ¿Enviar nueva Encuesta?");
                                        </script>';
                                        echo '<script>alert("Alert: Te quedan '.(3-$Veces).' intentos");
                                        </script>';
                                        include 'Encuesta/RealizaEncuesta.php';
                                    } else {
                                        echo '<script>alert("Error: ¡Ya excediste el numero de intentos!");
                                        window.location.href="EduPlusAlu.php"
                                        </script>';
                                    }
                                }
                                //include 'Encuesta/RealizaEncuesta.php';
