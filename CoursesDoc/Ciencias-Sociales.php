                            ...
                            <div class="col-md-2">
                                <ul class="navbar-nav sidebar" id="accordionSidebar">
                                    ...
                                    <li class="">
                                        ...
                                        <button class="btn btn-light" type="submit" name="Course" value="Ciencias-Sociales" href="../DocenteNotas/Evaluaciones.php">
                                            <i class="fas fa-fw fa-book"></i>
                                    ...
                                    <li class="">
                                        <form action="../Asistencias/AsistenciaDoc.php" method="post">
                                            <button class="btn btn-light" type="submit" name="Course" value="Ciencias-Sociales">
