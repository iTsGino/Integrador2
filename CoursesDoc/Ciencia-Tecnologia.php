                                ...
                                <ul class="navbar-nav sidebar" id="accordionSidebar">
                                    ...
                                    <li class="">
                                        <form action="../DocenteNotas/Evaluaciones.php" method="post">
                                            <button class="btn btn-light" type="submit" name="Course" value="Ciencia-Tecnologia" href="../DocenteNotas/Evaluaciones.php">
                                                <i class="fas fa-fw fa-book"></i>
                                                <span>Evaluaciones</span></button>
                                        </form>
                                    </li>
                                    <li class="">
                                        <a class="btn btn-light" href="">
                                    ...
                                    <li class="">
                                        <form action="../Asistencias/AsistenciaDoc.php" method="post">
                                            <button class="btn btn-light" type="submit" name="Course" value="Ciencia-Tecnologia">
