...
$CodioGrup = $_REQUEST['id'];
$CreaGrupo = $_REQUEST['CreaGrupo'];

$sql3 = $Con->prepare("SELECT * FROM grupos WHERE idGru = '$CodioGrup';");
$sql3->execute();
$res3 = $sql3->fetchAll(PDO::FETCH_ASSOC);
foreach ($res3 as $row) {
    $NomGru = $row['NomGru'];
}
$sql4 = $Con->prepare("SELECT c.CodCur, title, a.DniAlu, NomAlu, ApeAlu FROM alumno_curso ac, cursos c, alumno a 
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <hr>
                            ...
                            <div class="col-md-9">
                                <a type="button" href="CreaGrupo.php?Curso=<?php echo $Curso; ?>&CreaGrupo=<?php echo $CreaGrupo; ?>" class="btn btn-outline-success">
                                    <span>Regresar </span>
                                </a>
                                <br>
                                <br>
                                <div class="card shadow col-lg-9 p-4">
                                    <div class="container align-self-center p-6">
                                        <h2 align="center"class="font-weight-bold mb-3">Registro de Integrantes</h2>
                                        <p align="right">
                                            <small align="right" class="text-muted mb-5">Ingresa la siguiente información.</small>
                                        </p>
                                        <form action="Confirma.php" method="post">
                                            <div class="mb-4 font-weight-bold">
                                                <label for="notas"><i class="fas fa-fw fa-book"></i> Nombre Grupo</label><span class="text-danger"> *</span>
                                                <input type="text" class="form-control" name="NomGru" id="NomGru" value="<?php echo $NomGru; ?>" readonly>
                                                <div class="notas text-danger"></div>
                                            </div>
                                            <div class="mb-4 font-weight-bold">
                                                <label for="notas"><i class="fas fa-fw fa-book"></i> Nombre Alumno</label><span class="text-danger"> *</span>
                                                <select class="form-control" id="Integrante" name="Integrante" required>
                                                    <option value="Elegir">Elegir</option>
                                                    <?php
                                                    foreach ($res4 as $row) {
                                                        ?>
                                                        <option value="<?php echo $row['NomAlu']; ?>"><?php echo $row['NomAlu']; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $CodioGrup; ?>">
                                            <input type="hidden" name="CreaGrupo" value="<?php echo $CreaGrupo; ?>">
                                            <div align="center">
                                                <button id ="botton" type="submit" name="Añadir" class="btn btn-outline-success">
