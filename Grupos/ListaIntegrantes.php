...
$sql4 = $Con->prepare("SELECT id, NomGru, NomAlu, ApeAlu FROM grupos g, inte_grupo ig, alumno a WHERE g.idGru= ig.idGru AND ig.DniAlu = a.DniAlu
AND g.idGru = $id;");
$sql4->execute();
                        ...
                        <hr>
                            ...
                            <div class="col-md-8">
                                <div class="d-sm-flex justify-content-between">
                                    <a href="CreaGrupo.php?Curso=<?php echo $Curso; ?>&CreaGrupo=<?php echo $CreaGrupo; ?>" type="button" class="btn btn-outline-info">
                                        <span>Regresar</span>
                                    </a>
                                </div>
                                <br>
                                ...
                                ?>
                                <h4 class="h4 mb-0 text-gray-800">Nombre: <?php echo $NomGru; ?></h4>
                                <br>
                                <?php
                                    ...
                                    <tbody align="center">
                                        ...
                                        foreach ($res4 as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" href="Elimina.php?id=<?php echo $row['id']; ?>&Curso=<?php echo $Curso; ?>&CreaGrupo=<?php echo $CreaGrupo; ?>&idGru=<?php echo $id; ?>" name="Eliminar" class="btn btn-outline-warning">
                                                        <span>Eliminar</span>
                                                    </a>
                                                </td>
                                            </tr>
