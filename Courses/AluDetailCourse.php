                ...
                <div class="container-fluid">
                    ...
                    <!-- PAGE HEADING -->
                        ...
                        <div class="col-6 col-md-10">
                            ...
                            <br>
                            <?php
                            } elseif ($CursoSelect == 'Ingles') {
                                include 'Ingles.php';
                            } elseif ($CursoSelect == 'Comunicacion') {
                                include 'Comunicacion.php';
                            } elseif ($CursoSelect == 'Ciudadania-Civica') {
                                include 'Ciudadania-Civica.php';
                            } elseif ($CursoSelect == 'Educacion-Trabajo') {
                                include 'Educacion-Trabajo.php';
                            } else {
