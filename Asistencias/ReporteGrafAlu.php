...
$sql2 = $Con->prepare("SELECT * FROM asistencias WHERE Fecha BETWEEN '$fechaInicio' AND '$fechaFin' AND DniAlu = '$DniAlu';");
$sql2->execute();
...
//Salto de Linea
$pdf->Ln(10);
$pdf->Cell(38,10,'Fecha Desde: ',0,0,'C',0);
$pdf->Cell(68,10,utf8_decode($fechaInicio),0,0,'C',0);
//Salto de Linea
$pdf->Ln(10);
$pdf->Cell(38,10,'Fecha Hasta: ',0,0,'C',0);
$pdf->Cell(68,10,utf8_decode($fechaFin),0,0,'C',0);
//Salto de Linea
$pdf->Ln(20);
...
//Salto de Linea
$pdf->Ln(20);
$pdf->image($grafico, 20, 120, 210, 0, 'png');
