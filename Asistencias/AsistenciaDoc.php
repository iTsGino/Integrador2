    ...
    $sql3 = $Con->prepare("SELECT a.DniAlu, NomAlu, ApeAlu FROM alumno a, cursos c, alumno_curso dc WHERE a.DniAlu = dc.DniAlu AND c.CodCur = dc.CodCur
    AND c.CodCur = '$CodCurso';");
    $sql3->execute();
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Registro de Asistencias: <?php echo $SelectPag; ?></h1>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody align="center">
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <input type="hidden" name="dnialu[]" value="<?php echo $row['DniAlu']; ?>" readonly>
                                                        ...
                                                        <td>
                                                            <div class="d-grid gap-2 col-10">
                                                                <a id ="botton" href="Graficos.php?Course=<?php echo $SelectPag;?>&Dni=<?php echo $row['DniAlu']; ?>" class="btn btn-outline-danger">
                                                                    <span>Ver</span><i id="icono" class="bi bi-cursor-fill "></i>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
