...
$sql = $Con->prepare("SELECT NomDoc, ApeDoc FROM usuario u, docente d WHERE u.USUARIO = d.USUARIO AND d.USUARIO = '$Usuario'");
$sql->execute();
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="CoursesDoc/PrincipalCourse.php"> Ver Cursos</a>
                        <?php
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ayuda al Docente</h1>
                    </div>
                    <div class="container">
                        <form action="" method="post">
                            <nav class="nav nav-pills nav-justified">
                                ...
                                <button type="submit" class="nav-link border border-info" value="Video2" name="HelpGrupos" href="#">Ayuda Calendario</button>
                        ...
                        if(isset($_REQUEST['HelpCurso'])){
                            ?>
                            <div align="center">
                                <video src="img/CursosDoc.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        if(isset($_REQUEST['HelpGrupos'])){
                            ?>
                            <div align="center">
                                <video src="img/GruposDoc.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        if(isset($_REQUEST['HelpMens'])){
                            ?>
                            <div align="center">
                                <video src="img/MensajeriaDoc.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        ?>
