...
foreach($res as $row){
    ...
    <div class='card' style='width: 18rem;'>
            ...
            <div class='card-body'>
                ...
                <a type="submit" href='CoursesDoc/<?php echo $row['title']?>.php?CodCur=<?php echo $row['CodCur'];?>&Course=<?php echo $row['title'];?>' class='btn btn-warning' style="width:250px" name="Course" value="<?php echo $row['title']?>">See Course</a>
            </div>
    </div>
<?php } ?>
