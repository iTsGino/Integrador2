...
$sql3 = $Con->prepare("SELECT Cod_AluCur, c.CodCur, title, a.DniAlu, NomAlu, ApeAlu FROM alumno_curso ac, cursos c, alumno a 
where ac.CodCur = c.CodCur AND ac.DniAlu = a.DniAlu AND c.CodCur = '$CodCurso';");
$sql3->execute();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Registro de Notas: <?php echo $SelectPag; ?></h1>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-6 col-md-10">
                                <hr>
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <a class="d-none d-sm-inline-block btn btn-sm btn-outline-warning shadow-sm" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . 
                                    '/Proyecto-Integrador/DocenteNotas/Aprobados.php?CodCur='.$CodCurso.'&Course='.$SelectPag; ?>" ><i 
                                    class="fas fa-download fa-sm text-black-50"></i> Reporte Aprobados</a>

                                    <a class="d-none d-sm-inline-block btn btn-sm btn-outline-danger shadow-sm" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . 
                                    '/Proyecto-Integrador/DocenteNotas/Desaprobados.php?CodCur='.$CodCurso.'&Course='.$SelectPag; ?>" ><i 
                                    class="fas fa-download fa-sm text-black-50"></i> Reporte Desaprobados</a>

                                    <a class="d-none d-sm-inline-block btn btn-sm btn-outline-info shadow-sm" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . 
                                    '/Proyecto-Integrador/DocenteNotas/ReporteGeneral.php?CodCur='.$CodCurso.'&Course='.$SelectPag; ?>" ><i 
                                    class="fas fa-download fa-sm text-black-50"></i> Generar Reporte</a>
                                </div>
                                <hr>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="submit" class="btn btn-outline-danger" href="ModificaNota.php?CodAluCur=<?php echo $row['Cod_AluCur']; ?>&Course=<?php echo $SelectPag; ?>">
                                                        Registrar
                                                    </a>
                                                </td>
                                            </tr>
