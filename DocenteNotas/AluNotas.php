...
$sql3 = $Con->prepare("select * from cursos where title = '$CursoSelect';");
$sql3->execute();
...
$sql4 = $Con->prepare("SELECT NomAlu, ApeAlu, Nota1, Nota2, Nota3, Prom FROM alumno a, cursos c, alumno_curso ac, detalle_nota dn
                    ...
                    <!-- PAGE HEADING -->
                        ...
                        <div class="col-md-2">
                            <ul class="navbar-nav sidebar" id="accordionSidebar">
                                ...
                                <li class="">
                                    <form action="../DocenteNotas/AluNotas.php" method="post">
                                ...
                                <li class="">
                                    <form action="../Asistencias/AsistenciaAlu.php" method="post">
                                        <button class="btn btn-light" type="submit" name="Course" value="<?php echo $CursoSelect; ?>">
                        ...
                        <div class="col-6 col-md-10">
                            ...
                            <div class="d-grid gap-2 col-3 mx-auto">
                                <a class="d-none d-sm-inline-block btn btn-sm btn-outline-info shadow-sm" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . 
                                    '/Proyecto-Integrador/DocenteNotas/ReporteNotaAlu.php?CodCur='.$CodCur.'&Course='.$CursoSelect.'&Dni='.$DniAlu; ?>" ><i 
                                    class="fas fa-download fa-sm text-black-50"></i> Generar Reporte
                                </a>
                            </div>
                        </div>
                    </div>
