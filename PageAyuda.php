...
$sql = $Con->prepare("SELECT NomAlu, ApeAlu FROM usuario u, alumno a WHERE u.USUARIO = a.USUARIO AND a.USUARIO = '$Usuario'");
$sql->execute();
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-calendar" href="PageHorario.php"> Ver Horario</a>
                        
                        <h6 class="collapse-header">Disponible:</h6>
                        <a class="collapse-item" href="Courses/Matematica.php"> Ver Cursos</a>
                        <?php
                            //include 'Courses/AluCourse.php';
                            //header("Courses/Matematica.php")
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ayuda al Estudiante</h1>
                    </div>
                    <div class="container">
                        <form action="" method="post">
                            <nav class="nav nav-pills nav-justified">
                                <button type="submit" class="nav-link border border-info" value="Video1" name="HelpCurso" aria-current="page" href="#">Ayuda Cursos</button>
                                <button type="submit" class="nav-link border border-info" value="Video2" name="HelpCalendar" href="#">Ayuda Calendario</button>
                                <button type="submit" class="nav-link border border-info" value="Video3" name="HelpProm" href="#">Simulacion Promedio</button>
                                <button type="submit" class="nav-link border border-info" value="Video4" name="HelpMens" href="#">Ayuda Mensajería</button>
                            </nav>
                        </form>
                        <br>
                        <?php
                        if(isset($_REQUEST['HelpCurso'])){
                            ?>
                            <div align="center">
                                <video src="img/Curso.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        if(isset($_REQUEST['HelpCalendar'])){
                            ?>
                            <div align="center">
                                <video src="img/Calendario.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        if(isset($_REQUEST['HelpProm'])){
                            ?>
                            <div align="center">
                                <video src="img/SimulacionPromedio.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        if(isset($_REQUEST['HelpMens'])){
                            ?>
                            <div align="center">
                                <video src="img/Mensajeria.mp4" controls width="800px" height="480px"></video>
                            </div>
                            <?php
                        }
                        ?>
