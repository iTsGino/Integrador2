                ...
                <div class="container-fluid">
                    ...
                    <section class="content">
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-md-9">
                                <form id="formulario" method="post" action="NewMessage.php">
                                    <?php
                                    foreach ($res3 as $row) {
                                        $UsuEmi = $row['UsuEmi'];
                                        $UsuDes = $row['UsuDes'];
                                    ...
                                    <br>
                                    <?php
                                    if($Direccion2 != "/Proyecto-Integrador/Mensajes/Enviados.php" && $Direccion2 != '/Proyecto-Integrador/Mensajes/Papelera.php'){
                                        ?>
