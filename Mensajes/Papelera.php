...
$sql3 = $Con->prepare("SELECT * FROM mensajes WHERE (UsuDes = '$Usuario' or UsuEmi='$Usuario') and tipo='Papelera';");
$sql3->execute();
$res3 = $sql3->fetchAll(PDO::FETCH_ASSOC);

$sql4 = $Con->prepare("select * from mensajes where tipo='Enviado' and UsuDes = '$Usuario';");
$sql4->execute();
...
$sql5 = $Con->prepare("SELECT * FROM mensajes WHERE UsuEmi = '$Usuario' and tipo='Enviado';");
$sql5->execute();
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="icheck-primary">
                                                                <a type="button" class="btn btn-default btn-sm" href="Elimina.php?id=<?php echo $row['id']; ?>">
