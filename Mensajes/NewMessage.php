...
$sql2 = $Con->prepare("SELECT NomAlu, ApeAlu FROM usuario u, alumno a WHERE u.USUARIO = a.USUARIO AND a.USUARIO = '$Usuario'");
$sql2->execute();
$res2 = $sql2->fetchAll(PDO::FETCH_ASSOC);

$sql3 = $Con->prepare("SELECT * FROM usuario WHERE USUARIO != '$Usuario'");
$sql3->execute();
...
if($Direccion == "/Proyecto-Integrador/Mensajes/ReadMail.php"){
    $id = $_REQUEST['id'];
    $sql4 = $Con->prepare("SELECT * FROM mensajes WHERE id = $id;");
    $sql4->execute();
...
<body id="page-top">
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item active">
                                    <a href="../PageMailAlu.php" class="nav-link">
                                        <i class="fas fa-inbox"></i> Bandeja de Entrada
                                        <span class="badge bg-primary float-right">12</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                    <a href="Enviados.php" class="nav-link">
                                        <i class="far fa-envelope"></i> Enviados
                                        <span class="badge bg-warning float-right">9</span>
                                    </a>
                                    </li>
                                    <li class="nav-item">
                                    <a href="Papelera.php" class="nav-link">
                            ...
                            <!-- /.col -->
                            <div class="col-md-9">
                                <form id="formulario" method="get" action="SendMen.php">
                                    <div class="form-row mb-2 font-weight-bold">
                                        ...
                                        <div class="form-group col-md-10">
                                            ...
                                            if($Direccion == "/Proyecto-Integrador/Mensajes/ReadMail.php"){
                                                ...
                                                ?>
                                                <select class="form-control" aria-label="Default select example" id="Destinatario" name="Destinatario" required>
                                    ...
                                    <div class="form-row mb-2 font-weight-bold">
                                        ...
                                        <div class="form-group col-md-10">
                                            <input type="text" class="form-control" name="Emisor" id="Emisor" value="<?php echo $Usuario ?>" readonly>
                                            <div class="apellido text-danger"></div>
                                        </div>
                                    </div>
                                    <div class="form-row mb-2 font-weight-bold">
                                    ...
                                    <textarea name="Mensaje" id="editor1" class="editor1" required=""></textarea>
                                    <br>
                                    <button type="submit" class="btn btn-outline-danger">Enviar Mensaje</button>
                                </form>
    ...
    <script type="text/javascript">
        window.onload = function(){
            ...
            CKFinder.setupCKEditor(editor, 'http://localhost/Proyecto-Integrador/js/ckfinder');
        }
    </script>
