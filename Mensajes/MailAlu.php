...
<section class="content">
      <div class="row">
        <div class="col-md-3">
          <form action="Mensajes/NewMessage.php" method="post">
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="Mensajes/Enviados.php" class="nav-link">
                    <i class="far fa-envelope"></i> Enviados
                    <span class="badge bg-warning float-right"><?php echo $ConEnviado; ?></span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="Mensajes/Papelera.php" class="nav-link">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    foreach ($res2 as $row) {
                      ?>
                      <form action="Mensajes/ReadMail.php" method="post">
                          <tr>
                              <td>
                                  <div class="icheck-primary">
                                    <a type="button" class="btn btn-default btn-sm" href="Mensajes/MandaPapelera.php?id=<?php echo $row['id']; ?>">
