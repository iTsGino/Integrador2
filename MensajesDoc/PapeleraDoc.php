            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-md-3">
                                <form action="NewMessageDoc.php" method="post">
                                    ...
                                    <div class="table-responsive mailbox-messages">
                                        <table class="table table-hover table-striped">
                                            <tbody>
                                                ...
                                                foreach ($res3 as $row) {
                                                ?>
                                                <form action="ReadMailDoc.php" method="post">
                                                    <tr>
                                                        <td>
                                                            <div class="icheck-primary">
                                                                <a type="button" class="btn btn-default btn-sm" href="EliminaDoc.php?id=<?php echo $row['id']; ?>">
